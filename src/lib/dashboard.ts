...
export type CardId =
  | "focus_breakdown" | "site_breakdown" | "category_breakdown" | "focus_score"
  | "tracking_now" | "today_stats" | "tasks" | "notes";
...
export const CARD_CATALOG: { id: CardId; title: string }[] = [
  ...
  { id: "site_breakdown", title: "Site focus breakdown" },
